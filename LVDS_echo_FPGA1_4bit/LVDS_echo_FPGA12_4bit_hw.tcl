...
# Sat Jun 23 02:26:17 AZOST 2018
# DO NOT MODIFY


# 
# LVDS_echo_FPGA12_4bit "LVDS_echo_FPGA12_4bit" v1.0
#  2018.06.23.02:26:17
# 
# 
...
# 
# module LVDS_echo_FPGA12_4bit
# 
set_module_property DESCRIPTION ""
set_module_property NAME LVDS_echo_FPGA12_4bit
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME LVDS_echo_FPGA12_4bit
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL Both_FPGA_Top
...
add_fileset_file Both_FPGA_Top.v VERILOG PATH src_files/Both_FPGA_Top.v TOP_LEVEL_FILE
...
add_fileset_file FPGA12_TopNiosInterface.v VERILOG PATH src_files/FPGA12_TopNiosInterface.v
add_fileset_file FPGA1_TopNiosInterface.v VERILOG PATH src_files/FPGA1_TopNiosInterface.v
add_fileset_file FPGA1_TopNiosInterface.v.bak OTHER PATH src_files/FPGA1_TopNiosInterface.v.bak
add_fileset_file FPGA2_rst_TopInterface.v VERILOG PATH src_files/FPGA2_rst_TopInterface.v
...
add_fileset_file SyncFIFO.v VERILOG PATH src_files/SyncFIFO.v
add_fileset_file SyncFIFO1.v VERILOG PATH src_files/SyncFIFO1.v
add_fileset_file clk_counter.v VERILOG PATH src_files/clk_counter.v
...
add_fileset_file rx.v VERILOG PATH src_files/rx.v
add_fileset_file tb.v VERILOG PATH src_files/tb.v
add_fileset_file tx.v VERILOG PATH src_files/tx.v
...
add_interface_port conduit_end tx_out_fpga1 tx_out_fpga1 Output 1
add_interface_port conduit_end tx_outclock_fpga1 tx_outclock_fpga1 Output 1
add_interface_port conduit_end RDY_from_recv_fpga1 rdy_from_recv_fpga1 Input 1
add_interface_port conduit_end rx_in_fpga1 rx_in_fpga1 Input 1
add_interface_port conduit_end rx_inclock_fpga1 rx_inclock_fpga1 Input 1
add_interface_port conduit_end RDY_for_trans_fpga1 rdy_for_trans_fpga1 Output 1
add_interface_port conduit_end tx_out_fpga2 tx_out_fpga2 Output 1
add_interface_port conduit_end tx_outclock_fpga2 tx_outclock_fpga2 Output 1
add_interface_port conduit_end RDY_from_recv_fpga2 rdy_from_recv_fpga2 Input 1
add_interface_port conduit_end rx_in_fpga2 rx_in_fpga2 Input 1
add_interface_port conduit_end rx_inclock_fpga2 rx_inclock_fpga2 Input 1
add_interface_port conduit_end RDY_for_trans_fpga2 rdy_for_trans_fpga2 Output 1
add_interface_port conduit_end RST_N_out rst_n_out Output 1
add_interface_port conduit_end RST_N_gpio rst_n_gpio Input 1
add_interface_port conduit_end led_fpga2 led_fpga2 Output 8
add_interface_port conduit_end led_fpga1 led_fpga1 Output 8
