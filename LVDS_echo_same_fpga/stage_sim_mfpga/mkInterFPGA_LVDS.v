...
//
// On Mon Jun 18 16:53:02 IST 2018
//
//
// Ports:
// Name                         I/O  size props
...
// RDY_enq_serial_put             O     1 reg
// instnum                        I     3 unused
// CLK_clkinB                     I     1 unused
// CLK_clkinA                     I     1 clock
// reset_A                        I     1 reset
// tx_put                         I    32 reg
// enq_serial_put                 I    32 reg
// EN_tx_put                      I     1
...
module mkInterFPGA_LVDS(instnum,
  ...
  wire [31 : 0] outin_$D_IN, outin_$D_OUT;
  wire outin_$CLR, outin_$DEQ, outin_$EMPTY_N, outin_$ENQ, outin_$FULL_N;

  // action method tx_put
  assign RDY_tx_put = inout_$FULL_N ;

  // actionvalue method rx_get
  assign rx_get = outin_$D_OUT ;
  assign RDY_rx_get = outin_$EMPTY_N ;
  ...
  // action method enq_serial_put
  assign RDY_enq_serial_put = outin_$FULL_N ;

  // submodule inout_
  SizedFIFO #(.p1width(32'd32),
	      .p2depth(32'd5),
	      .p3cntr_width(32'd2),
	      .guarded(32'd1)) inout_(.RST(reset_A),
				      .CLK(CLK_clkinA),
				      .D_IN(inout_$D_IN),
				      .ENQ(inout_$ENQ),
				      .DEQ(inout_$DEQ),
  ...
  SizedFIFO #(.p1width(32'd32),
	      .p2depth(32'd5),
	      .p3cntr_width(32'd2),
	      .guarded(32'd1)) outin_(.RST(reset_A),
				      .CLK(CLK_clkinA),
				      .D_IN(outin_$D_IN),
				      .ENQ(outin_$ENQ),
				      .DEQ(outin_$DEQ),
				      .CLR(outin_$CLR),
				      .D_OUT(outin_$D_OUT),
				      .FULL_N(outin_$FULL_N),
				      .EMPTY_N(outin_$EMPTY_N));
  ...
  // submodule outin_
  assign outin_$D_IN = enq_serial_put ;
  assign outin_$ENQ = EN_enq_serial_put ;
  assign outin_$DEQ = EN_rx_get ;
  assign outin_$CLR = 1'b0 ;
