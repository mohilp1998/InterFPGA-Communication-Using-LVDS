...
//
// On Tue Jun 19 14:36:25 IST 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkNodeTask_echo2(CLK,
  ...
  wire CAN_FIRE_RL_mkConnectionAVtoAf,
       ...
       WILL_FIRE_RL_core_action_l410c15,
       WILL_FIRE_RL_core_action_l412c3,
       WILL_FIRE_RL_core_action_l424c15,
       WILL_FIRE_RL_core_action_l431c3,
       WILL_FIRE_RL_core_action_l441c15,
       WILL_FIRE_RL_core_action_l443c5,
       WILL_FIRE_RL_core_action_l448c15,
       WILL_FIRE_RL_core_action_l454c9,
  ...
  // rule RL_core_action_l410c15
  assign WILL_FIRE_RL_core_action_l410c15 =
	     core_dtlogger_initialized &&
	     (core_state_mkFSMstate == 4'd1 ||
	      core_state_mkFSMstate == 4'd8) ;

  // rule RL_core_action_l412c3
  assign WILL_FIRE_RL_core_action_l412c3 =
	     pkt_nw2c_0$EMPTY_N && core_state_mkFSMstate == 4'd2 ;

  // rule RL_core_action_l424c15
  assign WILL_FIRE_RL_core_action_l424c15 =
	     core_dtlogger_initialized && core_state_mkFSMstate == 4'd3 ;

  // rule RL_core_action_l431c3
  assign WILL_FIRE_RL_core_action_l431c3 =
	     core_dtlogger_initialized && core_state_mkFSMstate == 4'd4 ;

  // rule RL_core_action_l441c15
  assign WILL_FIRE_RL_core_action_l441c15 =
	     core_dtlogger_initialized && core_state_mkFSMstate == 4'd5 ;

  // rule RL_core_action_l443c5
  assign WILL_FIRE_RL_core_action_l443c5 =
	     pkt_c2nw$FULL_N && core_state_mkFSMstate == 4'd6 ;

  // rule RL_core_action_l448c15
  assign WILL_FIRE_RL_core_action_l448c15 =
  ...
  // rule RL_core_action_l454c9
  assign WILL_FIRE_RL_core_action_l454c9 =
  ...
  assign core_saved_source_address$EN = WILL_FIRE_RL_core_action_l412c3 ;
  ...
  // register core_state_mkFSMstate
  always@(WILL_FIRE_RL_core_action_l454c9 or
	  WILL_FIRE_RL_core_action_l410c15 or
	  WILL_FIRE_RL_core_action_l412c3 or
	  WILL_FIRE_RL_core_action_l424c15 or
	  WILL_FIRE_RL_core_action_l431c3 or
	  WILL_FIRE_RL_core_action_l441c15 or
	  WILL_FIRE_RL_core_action_l443c5 or WILL_FIRE_RL_core_action_l448c15)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_core_action_l454c9: core_state_mkFSMstate$D_IN = 4'd1;
      WILL_FIRE_RL_core_action_l410c15: core_state_mkFSMstate$D_IN = 4'd2;
      WILL_FIRE_RL_core_action_l412c3: core_state_mkFSMstate$D_IN = 4'd3;
      WILL_FIRE_RL_core_action_l424c15: core_state_mkFSMstate$D_IN = 4'd4;
      WILL_FIRE_RL_core_action_l431c3: core_state_mkFSMstate$D_IN = 4'd5;
      WILL_FIRE_RL_core_action_l441c15: core_state_mkFSMstate$D_IN = 4'd6;
      WILL_FIRE_RL_core_action_l443c5: core_state_mkFSMstate$D_IN = 4'd7;
      WILL_FIRE_RL_core_action_l448c15: core_state_mkFSMstate$D_IN = 4'd8;
  ...
  assign core_x$EN = WILL_FIRE_RL_core_action_l412c3 ;
  ...
  assign pkt_c2nw$ENQ = WILL_FIRE_RL_core_action_l443c5 ;
  ...
  assign pkt_nw2c_0$DEQ = WILL_FIRE_RL_core_action_l412c3 ;
  ...
  begin
    case (toCore_inFifo_0$D_OUT[24:21])
      ...
      4'd4: IF_toCore_inFifo_0_first__65_BITS_24_TO_21_78__ETC___d395 = 32'd3;
  ...
  begin
    case (toCore_inFifo_1$D_OUT[24:21])
      ...
      4'd4: IF_toCore_inFifo_1_first__11_BITS_24_TO_21_24__ETC___d441 = 32'd3;
  ...
  begin
	...
	core_task_info <= `BSV_ASSIGNMENT_DELAY 8'd6;
  ...
  begin
    #0;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l410c15)
	$fwrite(core_dtlogger_dlog,
		"%d\t: tid=%s ",
		$unsigned(core_dtlogger_cticks),
		"6",
		"STATE (enter)\trecv_11_l17c8 ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l410c15) $fwrite(core_dtlogger_dlog, "\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l410c15)
	$write("%d\t: tid=%s ",
	       $unsigned(core_dtlogger_cticks),
	       ...
	       "STATE (enter)\trecv_11_l17c8 ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l410c15) $write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l410c15) $fflush(core_dtlogger_dlog);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l412c3 && pkt_nw2c_0$D_OUT[32:29] != 4'd0)
	$display("address(mismatch? %d (exp:%d, got:%d))/type(mismatch? %d)%s recv_11_l17c8",
		 1'd1,
		 $signed(32'd0),
		 ...
		 "echo2");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l424c15)
	$fwrite(core_dtlogger_dlog,
		"%d\t: tid=%s ",
		$unsigned(core_dtlogger_cticks),
		"6",
		"STATE (exit)\trecv_11_l17c8 ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l424c15) $fwrite(core_dtlogger_dlog, "\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l424c15)
	$write("%d\t: tid=%s ",
	       $unsigned(core_dtlogger_cticks),
	       ...
	       "STATE (exit)\trecv_11_l17c8 ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l424c15) $write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l424c15) $fflush(core_dtlogger_dlog);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l431c3)
	$fwrite(core_dtlogger_dlog,
		"%d\t: tid=%s ",
		$unsigned(core_dtlogger_cticks),
		"6");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l431c3)
	$fwrite(core_dtlogger_dlog, " displaystmt_12_l18c11 instance=x\t");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l431c3)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l431c3) $fwrite(core_dtlogger_dlog, "\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l431c3)
	$write("%d\t: tid=%s ", $unsigned(core_dtlogger_cticks), "6");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l431c3)
	$write(" displaystmt_12_l18c11 instance=x\t");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l431c3) $write("X { ", "v: ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l431c3) $write("'h%h", core_x, " }");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l431c3) $write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l431c3) $fflush(core_dtlogger_dlog);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l441c15)
	$fwrite(core_dtlogger_dlog,
		"%d\t: tid=%s ",
		$unsigned(core_dtlogger_cticks),
		"6",
		"STATE (enter)\tsend_13_l19c8 ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l441c15) $fwrite(core_dtlogger_dlog, "\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l441c15)
	$write("%d\t: tid=%s ",
	       $unsigned(core_dtlogger_cticks),
	       ...
	       "STATE (enter)\tsend_13_l19c8 ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l441c15) $write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l441c15) $fflush(core_dtlogger_dlog);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l448c15)
	$fwrite(core_dtlogger_dlog,
		"%d\t: tid=%s ",
		$unsigned(core_dtlogger_cticks),
		"6",
		"STATE (exit)\tsend_13_l19c8 ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l448c15) $fwrite(core_dtlogger_dlog, "\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l448c15)
	$write("%d\t: tid=%s ",
	       $unsigned(core_dtlogger_cticks),
	       ...
	       "STATE (exit)\tsend_13_l19c8 ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l448c15) $write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l448c15) $fflush(core_dtlogger_dlog);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l410c15 &&
	  (WILL_FIRE_RL_core_action_l412c3 ||
	   WILL_FIRE_RL_core_action_l424c15 ||
	   ...
	   WILL_FIRE_RL_core_action_l443c5 ||
	   WILL_FIRE_RL_core_action_l448c15))
	$display("Error: \"../src/Tasks.bsv\", line 410, column 15: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_core_action_l410c15] and\n  [RL_core_action_l412c3, RL_core_action_l424c15, RL_core_action_l431c3,\n  RL_core_action_l441c15, RL_core_action_l443c5, RL_core_action_l448c15] )\n  fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l412c3 &&
	  (WILL_FIRE_RL_core_action_l424c15 ||
	   WILL_FIRE_RL_core_action_l431c3 ||
	   WILL_FIRE_RL_core_action_l441c15 ||
	   WILL_FIRE_RL_core_action_l443c5 ||
	   WILL_FIRE_RL_core_action_l448c15))
	$display("Error: \"../src/Tasks.bsv\", line 412, column 3: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_core_action_l412c3] and\n  [RL_core_action_l424c15, RL_core_action_l431c3, RL_core_action_l441c15,\n  RL_core_action_l443c5, RL_core_action_l448c15] ) fired in the same clock\n  cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l424c15 &&
	  (WILL_FIRE_RL_core_action_l431c3 ||
	   WILL_FIRE_RL_core_action_l441c15 ||
	   WILL_FIRE_RL_core_action_l443c5 ||
	   WILL_FIRE_RL_core_action_l448c15))
	$display("Error: \"../src/Tasks.bsv\", line 424, column 15: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_core_action_l424c15] and\n  [RL_core_action_l431c3, RL_core_action_l441c15, RL_core_action_l443c5,\n  RL_core_action_l448c15] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l431c3 &&
	  (WILL_FIRE_RL_core_action_l441c15 ||
	   WILL_FIRE_RL_core_action_l443c5 ||
	   WILL_FIRE_RL_core_action_l448c15))
	$display("Error: \"../src/Tasks.bsv\", line 431, column 3: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_core_action_l431c3] and\n  [RL_core_action_l441c15, RL_core_action_l443c5, RL_core_action_l448c15] )\n  fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l441c15 &&
	  (WILL_FIRE_RL_core_action_l443c5 ||
	   WILL_FIRE_RL_core_action_l448c15))
	$display("Error: \"../src/Tasks.bsv\", line 441, column 15: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_core_action_l441c15] and\n  [RL_core_action_l443c5, RL_core_action_l448c15] ) fired in the same clock\n  cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l443c5 && WILL_FIRE_RL_core_action_l448c15)
	$display("Error: \"../src/Tasks.bsv\", line 443, column 5: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_core_action_l443c5] and\n  [RL_core_action_l448c15] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_core_action_l454c9 &&
	  (WILL_FIRE_RL_core_action_l410c15 ||
	   WILL_FIRE_RL_core_action_l412c3 ||
	   WILL_FIRE_RL_core_action_l424c15 ||
	   WILL_FIRE_RL_core_action_l431c3 ||
	   ...
	   WILL_FIRE_RL_core_action_l443c5 ||
	   WILL_FIRE_RL_core_action_l448c15))
	$display("Error: \"../src/Tasks.bsv\", line 454, column 9: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_core_action_l454c9] and\n  [RL_core_action_l410c15, RL_core_action_l412c3, RL_core_action_l424c15,\n  RL_core_action_l431c3, RL_core_action_l441c15, RL_core_action_l443c5,\n  RL_core_action_l448c15] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (core_running &&
	  core_abort_whas__84_AND_core_abort_wget__85_86_ETC___d252 &&
	  !core_start_reg)
	...
	begin
	  TASK_fopen___d171 = $fopen("log_echo2_node.6.debug.log", "w");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (!core_dtlogger_initialized)
	begin
	  TASK_fopen___d172 = $fopen("log_echo2_node.6.trace.log", "w");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (!core_dtlogger_initialized &&
	...
	begin
	  TASK_fopen___d263 =
	      $fopen("log_ToNetworkTask_echo2_node.6.debug.log", "w");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (!fromCore_dtlogger_initialized)
	begin
	  TASK_fopen___d264 =
	      $fopen("log_ToNetworkTask_echo2_node.6.trace.log", "w");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (!fromCore_dtlogger_initialized &&
	...
	$display("Debug and Trace files created");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_toCore_pack && toCore_inFifo_0$D_OUT[29:26] != 4'd6)
	$write("\tBADFLIT this is Task_echo2 @ %d but I received ", 4'd6);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_toCore_pack && toCore_inFifo_0$D_OUT[29:26] != 4'd6)
	$write("Flit { ", "valid: ");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_toCore_pack_1 && toCore_inFifo_1$D_OUT[29:26] != 4'd6)
	$write("\tBADFLIT this is Task_echo2 @ %d but I received ", 4'd6);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_toCore_pack_1 && toCore_inFifo_1$D_OUT[29:26] != 4'd6)
	$write("Flit { ", "valid: ");
	...
	begin
	  TASK_fopen___d342 =
	      $fopen("log_FromNetworkTask_echo2_node.6.debug.log", "w");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (!toCore_dtlogger_initialized)
	begin
	  TASK_fopen___d343 =
	      $fopen("log_FromNetworkTask_echo2_node.6.trace.log", "w");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (!toCore_dtlogger_initialized &&
