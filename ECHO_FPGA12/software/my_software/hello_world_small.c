...
#define COMPONENT_BASE ECHO_FPGA12_COMPONENT_0_BASE
#define COMPONENT_IRQ ECHO_FPGA12_COMPONENT_0_IRQ
#define COMPONENT_IRQ_ID ECHO_FPGA12_COMPONENT_0_IRQ_INTERRUPT_CONTROLLER_ID
...
unsigned int printSend = 1;
unsigned int printRcv = 1;
